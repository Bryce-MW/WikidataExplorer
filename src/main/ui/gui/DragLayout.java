...
//NOTE: THIS WAS NOT WRITTEN BY ME. Source: https://tips4java.wordpress.com/2011/10/23/drag-layout/
...
public class DragLayout implements LayoutManager, java.io.Serializable {
    ...
    private Dimension getLayoutSize(Container parent) {
        ...
        return new Dimension(width + parentInsets.right, height + parentInsets.bottom);
    }
